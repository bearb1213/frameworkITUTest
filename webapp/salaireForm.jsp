...
<head>
    ...
    <title>Création de Salaires</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Ajoutez plusieurs salaires avec leurs devises</p>
        ...
        <form action="salaires" method="post" id="salaireForm">
        ...
        <div class="info-box">
            ...
            Ajoutez autant de salaires que vous le souhaitez.<br>
            Les données seront envoyées sous forme de tableau (Salaire[]).
        </div>
    </div>
