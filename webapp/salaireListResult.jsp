...
<head>
    ...
    <title>Résultat Salaires (ArrayList)</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <% if (success != null && success) { %>
            ...
            <div style="text-align: center;">
                <span class="type-badge">🔷 Type reçu: ArrayList&lt;Salaire&gt;</span>
            </div>
            ...
            <div class="salaires-section">
                ...
                <% 
                ArrayList<Salaire> salaires = (ArrayList<Salaire>) request.getAttribute("salaires");
                if (salaires != null) {
                    for (int i = 0; i < salaires.size(); i++) {
                        Salaire salaire = salaires.get(i);
                        if (salaire != null) {
                %>
        ...
        <div class="btn-container">
            <a href="salaireslist" class="btn btn-primary">Créer d'autres (ArrayList)</a>
            <a href="salaires" class="btn btn-secondary">Version Array</a>
